...
- **Linux packaged runtime/startup** — Ubuntu 24.04, Rust 1.97.1, and
  ...
  runtime with matched GStreamer 1.26.11 and the x86_64 AppImage. CI validates the exact artifact's native
