...
### Linux (deferred)
Linux is not part of the V1 release matrix — V0 deferred WebKitGTK `getDisplayMedia` validation, and the friends-only V1 audience is macOS + Windows only (the V1-P12 release workflow excludes Linux). When V0 is re-run on Linux and passes, V3 lights up Linux:
